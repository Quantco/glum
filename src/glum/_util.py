...
def _expand_categorical_penalties(
    ...
    # If `P1` or `P2` has the same shape as `X` before expanding
    # categorical columns, we assume that the penalty at the location of
    # categorical columns is the same for all levels.
