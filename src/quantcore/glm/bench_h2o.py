...
def h2o_bench(
    ...
    model_args = dict(
        ...
        standardize=False,
        solver="IRLSM",
        objective_epsilon=get_benchmark_convergence_tolerance(),
        beta_epsilon=get_benchmark_convergence_tolerance(),
        gradient_epsilon=get_benchmark_convergence_tolerance(),
    )
    if cv:
