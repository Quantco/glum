...
- Add methods for performing Wald tests based on a restriction matrix, feature names or term names
- Add a method for creating a coefficient table with confidence intervals and p-values
